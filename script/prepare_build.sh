...
mysql -u root -e "create table mysql_async_tests.transaction_test (id varchar(512) not null, primary key (id))"
...
PGDATA=/var/ramfs/postgresql/9.2/main
...
psql -d "netty_driver_test" -c "create table transaction_test ( id varchar(512) not null, constraint id_unique primary key (id))" -U $PGUSER
