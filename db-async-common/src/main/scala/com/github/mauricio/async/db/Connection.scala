...
trait Connection {
  ...
  /**
   * Disconnects this object. You should discard this object after calling this
   * method. No more queries will be accepted.
   *
   * @return
   */
   ...
   * }}}
   *
   * You can still use this method if your statement doesn't take any
   * parameters, the default is an empty collection.
   *
   * @param query
   * @param values
   * @return
