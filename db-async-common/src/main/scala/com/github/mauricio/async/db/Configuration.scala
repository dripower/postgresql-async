 ...
 *   the maximum size a message from the server could possibly have, this limits
 *   possible OOM or eternal loop attacks the client could have, defaults to 16
 *   MB. You can set this to any value you would like but again, make sure you
